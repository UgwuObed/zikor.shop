  ...
  return (
    <div className="rounded-lg bg-white shadow-sm border border-gray-100">
      <div className="flex items-center justify-between p-5 border-b border-gray-100">
        ...
        >
          {showHours ? 'Hide' : 'Show'}
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={`w-4 h-4 ml-1 transition-transform ${showHours ? 'rotate-180' : ''}`}>
            <path fillRule="evenodd" d="M5.23 15.79a.75.75 0 01-.02-1.06l4.25-4.5a.75.75 0 011.08 0l4.25 4.5a.75.75 0 11-1.08 1.04L10 11.832 6.29 15.77a.75.75 0 01-1.06.02z" clipRule="evenodd" />
          </svg>
        </button>
      </div>
                ...
                {daysOfWeek.map((day) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {!isActive && (
                        <span className="text-xs mt-1 max-w-full truncate">{getReadableHours(day)}</span>
                      )}
                    </button>
                  );
                })}
                    ...
                    <div className="space-y-4">
                      ...
                      {!completeBusinessHours[activeDay].closed && (
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          <div>
                            <label htmlFor={`close-${activeDay}`} className="block text-xs font-medium text-gray-700 mb-1">
                              Closing Time
                            </label>
                            <input
                              type="time"
...
export default EnhancedBusinessHours;